...
public class Hang_Constants {
    public static final class Pneumatics {
        ...
        public static final int MIN_PRESSURE = 0; // Min pressure threshold to turn the compressor on
        public static final int MAX_PRESSURE = 120; // Max pressure threshold to turn the compressor off
    }
}
